...
public class Update_price extends Frame implements ActionListener{
	private TextArea ta;
	...
	public Update_price( ){
		...
		Label l=new Label("Data From DB");
                ...
                Label l3=new Label("Enter new Price");
			...
			if(tf.getText().isEmpty() || tf2.getText().isEmpty()){
				...
				System.out.println("Insert Value");
                    ...
                    np=Integer.parseInt(tf2.getText());
                      String sq="update product set price="+np+" where p_no="+gv ; 
